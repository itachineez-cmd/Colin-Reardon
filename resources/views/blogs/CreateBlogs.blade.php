...
<header class="topbar">
  <div class="topbar__left">
    <a href="{{ route('blogs.index') }}" class="topbar__back" title="Back to Blogs">
      <svg viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M15 19l-7-7 7-7"/></svg>
    </a>
    <h1 class="topbar__title">Create Blog</h1>
  </div>
    ...
    <form action="{{ route('blogs.store') }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <input
          ...
          class="{{ $errors->has('heading') ? 'is-invalid' : '' }}"
        >
        @error('heading')
      ...
      <div class="form-group">
        ...
        <textarea
          ...
          class="{{ $errors->has('paragraph') ? 'is-invalid' : '' }}"
      ...
      <div class="form-group">
        ...
        <label
          for="image"
          class="file-label {{ $errors->has('image') ? 'is-invalid' : '' }}"
        >
          ...
          <span id="file-name">Choose an image (jpeg, png, jpg, gif, webp — max 2MB)</span>
        </label>
        <input
          type="file"
          id="image"
          ...
          onchange="document.getElementById('file-name').textContent = this.files[0] ? this.files[0].name : 'Choose an image (jpeg, png, jpg, gif, webp — max 2MB)'"
        >
        @error('image')
          <span class="field-error">⚠ {{ $message }}</span>
        @enderror
      ...
      <div class="btn-row">
        <a href="{{ route('blogs.index') }}" class="btn-cancel">Cancel</a>
