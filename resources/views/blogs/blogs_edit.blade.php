...
<header class="topbar">
  <div class="topbar__left">
    ...
    <h1 class="topbar__title">Edit Blog</h1>
  </div>
  ...
  <div class="form-card">
    <form action="{{ route('blogs.update', $blog->id) }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        >{{ old('paragraph', $blog->paragraph) }}</textarea>
        @error('paragraph')
          <span class="field-error">⚠ {{ $message }}</span>
        @enderror
      </div>
      ...
      <div class="form-group">
        ...
        <div class="img-preview-wrap">
          <p>Current Image</p>
          <img src="{{ $blog->image }}" alt="Current blog image" class="img-preview" id="img-preview">
        </div>
        ...
        >
          ...
          <span id="file-name">Upload a new image — or leave blank to keep the current one</span>
        </label>
        <input
          type="file"
          id="image"
