...
<title>Where Shadows Learn Your Name — Colin Reardon</title>
...
<header class="topbar">
  <div class="container topbar__inner">
    <a href="#" class="topbar__back"><i class="fa-solid fa-arrow-left"></i> Back to Collection</a>
    <a href="#" class="topbar__logo">Colin <em>Reardon</em></a>
  </div>
</header>
  ...
  <div class="container bh__grid">
    ...
    <div class="bh__cover-stage">
      <div class="bh__cover-frame" id="tiltCover">
        <img src="https://images.unsplash.com/photo-1519681393784-d120267933ba?q=80&w=800&auto=format&fit=crop" alt="Where Shadows Learn Your Name cover">
    ...
    <div class="bh__info fade-in">
      ...
      <h1 class="bh__title">Where Shadows<br><em>Learn Your Name</em></h1>
      <div class="bh__divider"></div>
      <p class="bh__excerpt">From condemned asylums to ink-black seas, a family returns to the house that remembers every name it has ever swallowed. Reardon's most unrelenting novel yet — a descent that doesn't end when you close the book.</p>

      <div class="bh__meta">
        <div class="bh__meta-item"><span class="num">368</span><span class="label">Pages</span></div>
        <div class="bh__meta-item"><span class="num">2025</span><span class="label">Published</span></div>
        <div class="bh__meta-item"><span class="num">Hardcover</span><span class="label">Format</span></div>
      </div>

      <a href="#" class="btn-amazon" id="buyBtn">
  ...
  <div class="container synopsis__grid">
    <div class="fade-in">
      ...
      <div class="synopsis__body">
        <p>The Ashworth house has stood empty for eleven years, its windows boarded, its garden gone feral. When Mara Ashworth inherits it, she tells herself she is only there to sell it. But the house has been waiting for someone to come home, and it is patient in the way only old, hungry things can be.</p>
        <p>As the nights grow longer, Mara begins to hear her own name spoken in rooms she hasn't entered — in a voice that sounds almost, but not quite, like hers. What follows is a slow unravelling of memory, identity, and the thin membrane between the living and whatever the house has kept for itself.</p>
      </div>
    </div>
...
<section class="related">
  <div class="container">
    <div class="related__header fade-in">
      ...
      <a href="#" class="topbar__back">View All Titles →</a>
    </div>
    <div class="related__grid">
      <article class="related-card fade-in">
        <div class="related-card__img"><img src="https://images.unsplash.com/photo-1476231682828-37e571bc172f?q=80&w=600&auto=format&fit=crop" alt="The Cold House"></div>
        <div class="related-card__body">
          <h3 class="related-card__title">The Cold House</h3>
          <a href="#" class="related-card__link">Read more →</a>
        </div>
      </article>
      <article class="related-card fade-in">
        <div class="related-card__img"><img src="https://images.unsplash.com/photo-1509281373149-e957c6296406?q=80&w=600&auto=format&fit=crop" alt="Ink Black Sea"></div>
        <div class="related-card__body">
          <h3 class="related-card__title">Ink Black Sea</h3>
          <a href="#" class="related-card__link">Read more →</a>
        </div>
      </article>
      <article class="related-card fade-in">
        <div class="related-card__img"><img src="https://images.unsplash.com/photo-1478760329108-5c3ed9d495a0?q=80&w=600&auto=format&fit=crop" alt="The Quiet Ward"></div>
        <div class="related-card__body">
          <h3 class="related-card__title">The Quiet Ward</h3>
          <a href="#" class="related-card__link">Read more →</a>
        </div>
      </article>
    </div>
...
<div class="sticky-buy" id="stickyBuy">
  <div class="sticky-buy__inner">
    <p class="sticky-buy__title"><span>Where Shadows Learn Your Name</span>Colin Reardon</p>
    <a href="#" class="btn-amazon btn-amazon--sm">
      <i class="fa-brands fa-amazon"></i>
      <span>Buy Now</span>
    </a>
  </div>
